...
# # os.chdir("rpa_basic_2_desktop") # rpa_basic 으로 작업 공간 이동
# # print(os.getcwd())
# # os.chdir("..") # 부모 폴더로 이동
# # print(os.getcwd())
# # os.chdir("../..") # 조부모 폴더로 이동 
...
# # 파일 경로에서 폴더 정보 가져오기
# #print(os.path.dirname(r"C:\Users\hansol\Desktop\new\my_file.txt"))
# # my_file이 빠진 new까지 파일 경로를 가져옴
...
# # 파일의 생성 날짜
# ctime=os.path.getctime("rpa_basic_2_desktop/11_file_system.py")
# print(ctime)
...
# # 파일 크기
# size = os.path.getsize("rpa_basic_2_desktop/11_file_system.py")
# print(size) # 바이트 단위로 파일 크기 가져오기

# 파일 목록 가져오기
# print(os.listdir()) # 모든 폴더, 파일 목록 가져오기
# print(os.listdir("rpa_basic_2_desktop")) # 주어진 폴더 밑에서 모든 폴더, 파일 목록 가져오기

# 파일 목록 가져오기 (하위 폴더 모두 포함)
# result = os.walk('rpa_basic_2_desktop') # 주어진 폴더 밑에 있는 모든 폴더, 파일 목록 가져오기
# print(result)
...
# 주어진 경로가 파일인지? 폴더인지?
# print(os.path.isdir("rpa_basic_2_desktop")) # rpa_basic_2_desktop은 폴더인가? True
...
# print(os.path.isfile("run_btnnnn.png"))
# # 이럴때는 그냥 False 출력

# # 주어진 경로가 존재하는지?
# if os.path.exists("rpa_basic_2_desktop"):
...
# # 파일명 변경하기 
# os.rename("new_file.txt","new_file_rename.txt") # new_file.txt -> new_file.rename.txt로 이름 변경
...
# os.rmidr('new_folders') # 폴더 안이 비었을 때만 삭제 가능
...
# shutil.copy2("run_btn.png","test_folder/copied2_run_btn.png") 

# copy, copyile : 메타정보 복사 X
# copy2 : 메타정보 복사 O
